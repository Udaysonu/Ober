...
func (c *greetServiceClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc_proto.GreetService/Greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greetServiceClient) GreetManyTimes(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (GreetService_GreetManyTimesClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], "/grpc_proto.GreetService/GreetManyTimes", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greetServiceClient) LongGreet(ctx context.Context, opts ...grpc.CallOption) (GreetService_LongGreetClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[1], "/grpc_proto.GreetService/LongGreet", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greetServiceClient) GreetEveryone(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetEveryoneClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], "/grpc_proto.GreetService/GreetEveryone", opts...)
	if err != nil {
		return nil, err
	}
...
func _GreetService_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc_proto.GreetService/Greet",
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_proto.GreetService",
